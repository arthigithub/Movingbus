...
GLfloat vertices[][3] ={{160,390,-70},{425,390,-70},{425,510,-70}, {160,520,-70},{135,370,70}, {400,370,70},
						{400,490,70}, {135,500,70},{135,447,70},{400,447,70},{425,467,-70},{410,520,-70},
			{385,500,70}, {160,467,-70},{320,467,-70},{320,520,-70},{380,520,-70},{380,390,-70},{320,390,-70}};
GLfloat colors[][3] = {{0.1,0.7,0.7},{0.7,0.7,1.0},{0.3,0.4,0.5}};
...
void text()
{
	...
	char string[]="KENGERI BUS STOP";
	char string1[]="";
	void *font=GLUT_BITMAP_TIMES_ROMAN_24;
	int i,j;
	void *font1=GLUT_BITMAP_TIMES_ROMAN_10;
	glColor3f(1.0,1.0,1.0);
	glRasterPos3f(200,602,-120);
...
void text2d()
{
   char string2[]="RajaRajeswari";
   void *font2=GLUT_BITMAP_TIMES_ROMAN_24;
   int k;
   glColor3f(0.0,0.0,0.0);
   glRasterPos3f(245,400,70);
   for(k=0;k<strlen(string2);k++)
   glutBitmapCharacter(font2,string2[k]);

   char string3[]="CollegeOf";
   void *font3=GLUT_BITMAP_TIMES_ROMAN_24;
   glColor3f(0.0,0.0,0.0);
   glRasterPos3f(250,380,70);
   for(k=0;k<strlen(string3);k++)
   glutBitmapCharacter(font3,string3[k]);

   char string4[]="Engineering";
   void *font4=GLUT_BITMAP_TIMES_ROMAN_24;
   glColor3f(0.0,0.0,0.0);
   glRasterPos3f(250,360,70);
   for(k=0;k<strlen(string4);k++)
   glutBitmapCharacter(font4,string4[k]);

   char string5[]="Kumbolgudu";
   void *font5=GLUT_BITMAP_TIMES_ROMAN_24;
   glColor3f(0.0,0.0,0.0);
   glRasterPos3f(250,340,70);
   for(k=0;k<strlen(string5);k++)
   glutBitmapCharacter(font5,string5[k]);
